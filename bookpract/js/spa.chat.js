...
spa.chat = (function (){
    ...
    var
        ...
        writeAlert, clearChat, setSliderPosition, 
    ...
    //Purpose:
    //  Given a window resize event, adjust the presetnation
    ...
    handleResize = function(){
        //dont do any if we dont have a slider container
    ...
    //ex: spa.chat.setSliderPosition('closed');
    ...
    // * false - The requested positoin was not achieved
    // Throws: none
    ...
    //Begin public method /configModule/
        ...
        //  Example: slider_open_em is th eopen hight in em's
        //Action:
    ...
    //Action:
    //  Appends the chat slider to the provided container and fills it with HTML 
    //  content. It then initializes elements, events, and handlers to provide 
    //  the user with a chat-room interface
    ...
    removeSlider = function () {
        //unwind initialiazation and state
